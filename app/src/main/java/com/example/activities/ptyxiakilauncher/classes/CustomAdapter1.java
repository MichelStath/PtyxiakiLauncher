...
import com.example.activities.ptyxiakilauncher.classes.Models.FastMessage;
...
public class CustomAdapter1 extends RecyclerView.Adapter<CustomAdapter1.MyViewHolder1> {
    ...
    private final List<FastMessage> messages;
    private final Helper.MessageDbHelper dbHelper;
    private FastMessage currentMessage;

   public CustomAdapter1(Context context, ArrayList<FastMessage> messages, MessageClickListener listener){
    ...
    public void onBindViewHolder(@NonNull MyViewHolder1 holder, int position) {
        ...
        holder.mainLayout1.setOnClickListener(v -> {
    ...
    public interface MessageClickListener {
        void onDeleteMessage(FastMessage message);
        void onUpdateMessage(FastMessage message);
    }
